...
const fixture=`<!doctype html><title>SelfGuide test fixture</title><aside>PRIVATE SIDEBAR SHOULD NOT BE READ</aside><button>Extra High</button><main id="messages"></main>
